...
class ScannetReferenceDataset(Dataset):
    ...
    def __len__(self):
        if self.scanrefer_new is not None:
    ...
    def __getitem__(self, idx):
        ...
        #TODO: fix the bert for new dataset logic
        if self.use_bert:
    ...
    def _tranform_des(self):
        ...
        return lang, lang_main, lang_bert
    ...
    def _load_data(self):
        ...
        self.lang, self.lang_main, self.lang_bert = self._tranform_des()
